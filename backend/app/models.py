...
class Batch(db.Model):
    ...
    category_id = db.Column(db.Integer, db.ForeignKey('exam_categories.id'), nullable=True)
...
class PythonMCQ(db.Model):
    ...
    batch_id = db.Column(db.Integer, db.ForeignKey('exam.batch_id'), nullable=True)
